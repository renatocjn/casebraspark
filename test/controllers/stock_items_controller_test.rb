...
class StockItemsControllerTest < ActionController::TestCase
  ...
  test "should create stock_item" do
    assert_difference('StockItem.count') do
      post :create, stock_item: { long_description: @stock_item.long_description, short_description: @stock_item.short_description, stock: @stock_item.stock }
    end
  ...
  test "should update stock_item" do
    patch :update, id: @stock_item, stock_item: { long_description: @stock_item.long_description, short_description: @stock_item.short_description, stock: @stock_item.stock }
    assert_redirected_to stock_item_path(assigns(:stock_item))
  end
