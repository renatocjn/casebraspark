...
class ComputersControllerTest < ActionController::TestCase
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post :create, computer: { harddrive: @computer.harddrive, memory: @computer.memory, processor: @computer.processor }
    end
  ...
  test "should update computer" do
    patch :update, id: @computer, computer: { harddrive: @computer.harddrive, memory: @computer.memory, processor: @computer.processor }
    assert_redirected_to computer_path(assigns(:computer))
  end
